            ...
            if (options.container != "") {
                ...
                if (options.display_profile) {
                    ...
                    if (is_tag)
                        ...
                        html += "<p class='instagram_username'" + styles.profile_name + "> <a href='https://www.instagram.com/" + options.username + "' rel='noopener' target='_blank'>@" + options.username.toUpperCase() + "</a> </p>";
